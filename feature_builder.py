...
class FeatureBuilder:
    ...
    def build_feature_row(self, signal: dict, market_row: dict | None = None):
        ...
        regime_label = str(signal.get("btc_market_regime_label", "calm") or "calm")
        ...
        feature_row = {
            ...
            "btc_live_price_kalman": _safe_float(signal.get("btc_live_price_kalman"), np.nan),
            "btc_live_spot_price_kalman": _safe_float(signal.get("btc_live_spot_price_kalman"), np.nan),
            "btc_live_index_price_kalman": _safe_float(signal.get("btc_live_index_price_kalman"), np.nan),
            "btc_live_mark_price_kalman": _safe_float(signal.get("btc_live_mark_price_kalman"), np.nan),
            ...
            "btc_live_spot_index_basis_bps_kalman": _safe_float(signal.get("btc_live_spot_index_basis_bps_kalman"), 0.0),
            "btc_live_mark_index_basis_bps_kalman": _safe_float(signal.get("btc_live_mark_index_basis_bps_kalman"), 0.0),
            "btc_live_mark_spot_basis_bps_kalman": _safe_float(signal.get("btc_live_mark_spot_basis_bps_kalman"), 0.0),
            ...
            "btc_live_return_1m_kalman": _safe_float(signal.get("btc_live_return_1m_kalman"), 0.0),
            "btc_live_return_5m_kalman": _safe_float(signal.get("btc_live_return_5m_kalman"), 0.0),
            "btc_live_return_15m_kalman": _safe_float(signal.get("btc_live_return_15m_kalman"), 0.0),
            "btc_live_return_1h_kalman": _safe_float(signal.get("btc_live_return_1h_kalman"), 0.0),
            ...
            "btc_live_confluence_kalman": _safe_float(signal.get("btc_live_confluence_kalman"), 0.0),
            ...
            "btc_market_regime_label": regime_label,
            "btc_market_regime_score": _safe_float(signal.get("btc_market_regime_score"), 0.0),
            "btc_market_regime_trend_score": _safe_float(signal.get("btc_market_regime_trend_score"), 0.0),
            "btc_market_regime_volatility_score": _safe_float(signal.get("btc_market_regime_volatility_score"), 0.0),
            "btc_market_regime_chaos_score": _safe_float(signal.get("btc_market_regime_chaos_score"), 0.0),
            "btc_market_regime_stability_score": _safe_float(signal.get("btc_market_regime_stability_score"), 1.0),
            "btc_market_regime_is_calm": int(_safe_float(signal.get("btc_market_regime_is_calm"), 1.0 if regime_label == "calm" else 0.0)),
            "btc_market_regime_is_trend": int(_safe_float(signal.get("btc_market_regime_is_trend"), 1.0 if regime_label == "trend" else 0.0)),
            "btc_market_regime_is_volatile": int(_safe_float(signal.get("btc_market_regime_is_volatile"), 1.0 if regime_label == "volatile" else 0.0)),
            "btc_market_regime_is_chaotic": int(_safe_float(signal.get("btc_market_regime_is_chaotic"), 1.0 if regime_label == "chaotic" else 0.0)),
            "btc_market_regime_primary_model": signal.get("btc_market_regime_primary_model", ""),
            "btc_market_regime_confidence_multiplier": _safe_float(signal.get("btc_market_regime_confidence_multiplier"), 1.0),
            "btc_market_regime_weight_legacy": _safe_float(signal.get("btc_market_regime_weight_legacy"), 0.0),
            "btc_market_regime_weight_stage1": _safe_float(signal.get("btc_market_regime_weight_stage1"), 0.0),
            "btc_market_regime_weight_stage2": _safe_float(signal.get("btc_market_regime_weight_stage2"), 0.0),
