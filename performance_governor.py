...
class PerformanceGovernor:
    ...
    def evaluate(self) -> dict:
        ...
        policy = {
            ...
            1: {"size_multiplier": self._env_float("GOV_LEVEL1_SIZE_MULTIPLIER", 0.5), "min_confidence": self._env_float("GOV_LEVEL1_MIN_ENTRY_CONFIDENCE", 0.62), "min_liquidity_score": self._env_float("GOV_LEVEL1_MIN_LIQUIDITY_SCORE", 0.40), "force_min_size": False, "top_signal_only": False},
            2: {"size_multiplier": self._env_float("GOV_LEVEL2_SIZE_MULTIPLIER", 0.35), "min_confidence": self._env_float("GOV_LEVEL2_MIN_ENTRY_CONFIDENCE", 0.78), "min_liquidity_score": self._env_float("GOV_LEVEL2_MIN_LIQUIDITY_SCORE", 0.55), "force_min_size": True, "top_signal_only": True},
        }[level]
