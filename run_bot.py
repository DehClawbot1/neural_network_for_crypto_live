...
def ensure_signature_type():
    ...
    print("  1 = Email / Magic Link / Google login  (most common for bot users)")
    print("      Use this when your Polymarket account is backed by a proxy wallet.")
    print("  2 = MetaMask / Rabby / browser extension wallet")
    print("      Use this when you trade through a browser wallet-connected proxy wallet.")
    print("  0 = Direct EOA wallet (no Polymarket account / direct signing wallet)")
    print("      Use this only when you are trading directly from the wallet itself.")
    print()
    if current in labels:
        print(f"Current setting: {current} ({labels[current]})")
    print("If you are unsure, start with 1. A wrong choice commonly shows $0 balance.")
    print()
