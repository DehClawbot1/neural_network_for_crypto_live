...
@lru_cache(maxsize=1)
def _build_execution_client() -> RepositoryPolymarketClient:
    return RepositoryPolymarketClient()


def get_execution_client(force_new: bool = False) -> RepositoryPolymarketClient:
    if force_new:
